...
export class AjudaCadastroFormularioComponent implements OnInit {
  ...
  constructor() {
    ...
    this.textoImportante01 += "IMPORTANTE: A premissa para concluir este cadastro é ter previamente cadastrado o 'Local', o 'Programa' e a 'Frequência' a ser utilizado."                           
    ...
    this.campos.push(["Frequência"   , "Código da frequência formulário em questão deve ser respondido. ( Clique na 'Lupa' ou pressione a tecla F2 do teclado para pesquisar. )"]);
